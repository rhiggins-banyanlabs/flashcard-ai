  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden flex items-center justify-center p-6">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/3 right-1/2 w-1 h-1 bg-primary rounded-full animate-pulse opacity-40"></div>
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        <Card className="bg-card/80 backdrop-blur-sm border-border/50 shadow-2xl hover:shadow-primary/10 transition-all duration-300">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl font-bold text-foreground mb-2">Join StudyCards</CardTitle>
            ...
            <form onSubmit={handleSignUp}>
              <div className="flex flex-col gap-6">
                <div className="space-y-3">
                  <Label className="text-foreground font-medium">Choose Your Theme</Label>
                  <ThemeSelector showTitle={false} compact={true} />
                </div>
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-primary-foreground font-semibold py-3 shadow-lg hover:shadow-primary/25 transition-all duration-300 cursor-pointer"
                  disabled={isLoading}
                >
